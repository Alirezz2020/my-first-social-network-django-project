...
from .forms import PostCreateUpdateForm,CommentCreateUpdateForm,CommentReplyForm,PostSearchForm
...
class PostDeleteView (LoginRequiredMixin,View):
    def get(self, request,post_id):
        ...
        if post.user_id == request.user.id:
            ...
            messages.error(request, 'You do not have permission to access this post.', 'danger')
...
class PostUpdateView (LoginRequiredMixin,View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, 'Your post has been updated.', 'success')
            return redirect('home:post_detail.html', kwargs['post_id'] , post.slug)
...
class PostAddReplyView (LoginRequiredMixin,View):
    ...
    def post(self, request, post_id, comment_id):
        ...
        return redirect('home:post', post_id, post.slug)
...
class PostLikeView (LoginRequiredMixin,View):
    def get(self, request, post_id):
        ...
        if like.exists():
            ...
            messages.success(request, 'Your post has been liked.', 'success')
        return redirect('home:post', post_id, post.slug)
